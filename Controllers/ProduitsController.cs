    ...
    namespace EcommerceProject.Controllers
    {
        public class ProduitsController : Controller
        {
            private static List<Produit> produits = new List<Produit>
            {
                ...
                new Produit { Id = 2, Nom = "Macbook pro 2", Description = "laptop", Prix = 1099m, ImageUrl = "/images/laptop-icon.png", Categorie = "Électronique" },
                new Produit { Id = 3, Nom = "Samsung s24 ultra 3", Description = "telephone", Prix = 899.99m, ImageUrl = "/images/phone-icon.png", Categorie = "Électronique" }
            };
